...
parser.add_argument("--real3d_path", type=str, default="./Real3D-AD-PCD")
...
for m in metas:
    filename = m["filename"]
    pcd = o3d.io.read_point_cloud(os.path.join(args.real3d_path,filename))
    ...
    file_path = os.path.join(args.real3d_path,filename).replace("Real3D-AD-PCD","real3D_down")
